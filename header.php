		...
		<div class="site-branding">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="custom-logo-link">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 234 84" xml:space="preserve">
					...
					<path class="st1" d="M145.4,71.9c-1.3,2-3,1.4-4.7,0.6c0.4-0.2,0.8-0.4,1.2-0.5C143,72,144.2,72,145.4,71.9z"/>
					<path class="st2" d="M95.5,53.1c2.2-3.3,4.5-5.4,7.3-6.8c1.4-0.7,3.3-1.8,4.5,0c1.2,1.9-0.8,3-2,3.9C102.6,51.9,99.7,52.9,95.5,53.1z"/>
				</svg>
			</a>
